...
//        let URL = "https://servicebeta.poems.in.th/FundSmart/api/funds/reports?AnalystReport=IPO"
        ...
        AF.request("https://servicebeta.poems.in.th/FundSmart/api/funds/reports").responseData { response in
...
//                    print("analystTalksData", analystTalksData)
    ...
    typealias FecthFundsAnalystReportModelDataCompletionHandler = (_ analystTalksData: [FundIPORolloverDatasModels]?,_ error: Error?) -> ()
    func fetchFundsanslystreportDatas() {
...
//                    let analystTalksData = try JSONDecoder().decode([FundsAnalystReportModel].self, from: fundAnalystTalkData)
